...
| <a name="input_dns_vpc"></a> [dns\_vpc](#input\_dns\_vpc) | n/a | <pre>object({<br>    vpc_id     = string<br>    vpc_region = optional(string, "us-east-1")<br>  })</pre> | <pre>{<br>  "vpc_id": "",<br>  "vpc_region": ""<br>}</pre> | no |
